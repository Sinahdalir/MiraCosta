 ...
 * ASSIGN nickels
 * ASSIGN pennies
 * CALL change(quarters, dimes, nickels, pennies, changeAmount)
 * PRINT num
 * FOR EACH 
...
public class ChangeDispenser {
	 ...
	 * 			int value of total
	 */
	//This Method very slow in efficiency and has been improved in the methods beneath and also the other class
	/**
