...
public class StudentDatabaseDriver 
{
	...
	public static void main(String[] args) 
	{
		...
		MySingleLinkedList<Student> list = new MySingleLinkedList<Student>();
		printMenu();
	...
	/**
	 * getInfo(Scanner) gets the info of a Student object and intitializes one 
	 * 
	 * @param keyboard
	 * 			Scanner object
	 * 
